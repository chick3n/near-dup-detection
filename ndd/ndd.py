...
def near_three_duplicates():
    ...
    filenames_of_first_ten = [detector.filename("file%02d.txt") % (f,) for f in range(10)]
    filenames_of_first_one_hundred = [detector.filename("file%02d.txt") % (f,) for f in range(100)]
